...
if ThemePrefs.Get("FancyUIBG") then
	return Def.ActorFrame {
		...
		LoadActor("_barcode") .. {
			InitCommand=cmd(zoomto,64,1024;blend,'BlendMode_Add';x,SCREEN_LEFT+36;y,SCREEN_CENTER_Y;diffusealpha,0.08);
			OnCommand=cmd(customtexturerect,0,0,1,1;texcoordvelocity,0,0.1);
		};
		LoadActor("_barcode") .. {
			InitCommand=cmd(zoomto,64,1024;blend,'BlendMode_Add';x,SCREEN_RIGHT-36;y,SCREEN_CENTER_Y;diffusealpha,0.08);
			OnCommand=cmd(customtexturerect,0,0,1,1;texcoordvelocity,0,0.1);
		};
